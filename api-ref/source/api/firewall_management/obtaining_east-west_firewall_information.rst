...
.. table:: **Table 7** ErInstance
   ...
   +-----------------------+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | attachment_id         | String | Attachment ID of an enterprise router. This attachment is used to connect the firewall and the enterprise router. To obtain the value of this field, query the enterprise router by er_id on the Enterprise Router page, and then query the attachment on the **Manage Attachment** page. |
   +-----------------------+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
